...
declare_id!("8oBQJACHFg3i9A8r6CF6B2hCDY3y2NVvDZn6u97UbeDM");
...
pub mod swe_project_1 {
    ...
    pub fn update_property(
        ...
        instructions::update_property::update_property(
            ctx,
            new_name,
            new_symbol,
            new_uri,
    ...
    pub fn book_property(
        ...
        instructions::book_property::book_property(ctx, check_in_date, check_out_date)
    }

    pub fn finalize_booking(ctx: Context<FinalizeBooking>) -> Result<()> {
        instructions::finalize_booking::finalize_booking(ctx)
    }
